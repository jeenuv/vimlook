...
script, as of now, can launch VIM for replying and forwading mails within
Outlook.
...
1.  Make sure the paths in DoLaunchVIM subroutine in vimlook.bas file are valid
2.  Open Outlook.
...
10. In addition, you  can open a mail item in its own window, right-click on
    ...
    window.
11. Select a mail and click on the button on toolbar. It should now launch VIM
    with mail formatted accordingly. Save and quit (:wq) and you'll get the
    composed mail opened in Outlook ready to be sent.
12. The file vimlook.vim is sourced before launching VIM. So you can customize
